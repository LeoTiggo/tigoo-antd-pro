...
import EditNoticeInfoForm from '@/components/NoticeEdit';
    ...
    return (
      ...
      >
        ...
        <FormItem labelCol={{ span: 5 }} wrapperCol={{ span: 15 }} label="发布日期">
          {form.getFieldDecorator('releaseDate')(<DatePicker style={{ width: '100%' }} placeholder="请选择" format={'YYYY-MM-DD'}/>)}
        </FormItem>
        ...
        <Card bordered={false}>
          <div className={styles.tableList}>
            ...
            <div className={styles.tableListOperator}>
              <p dangerouslySetInnerHTML={{ __html: formVals.releaseContent }} />
...
class TableList extends PureComponent {
  ...
  columns = [
    ...
    },
    {
      ...
      render:  (text, record, index) => `${moment(record.releaseDate).format('YYYY-MM-DD')}`,
    },
    {
      title: '操作',
      render: (text, record) => (
    ...
    confirm({
      ...
      onOk() {
        ...
        return new Promise((res, rej) => {
          ...
          dispatch({
            type: 'workNotice/workNoticeDelete',
